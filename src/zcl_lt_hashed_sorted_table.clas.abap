CLASS zcl_lt_hashed_sorted_table DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_lt_hashed_sorted_table IMPLEMENTATION.
...
*   *Add 50 new connection numbers and 2000 days of flig!hts for each
